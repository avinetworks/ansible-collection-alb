...
[vmware.alb.avi_taskjournal](https://github.com/vmware/ansible-collection-alb/blob/eng/docs/avi_taskjournal.rst)|Module to create update or delete TaskJournal
